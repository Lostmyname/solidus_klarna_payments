...
Gem::Specification.new do |spec|
  ...
  # TODO: Should this really be limited to Solidus < v2.4?
  spec.add_dependency "solidus_core", ">= 1.3.0.a", "< 2.4"
  spec.add_dependency "solidus_frontend", ">= 1.3.0.a", "< 2.4"
  spec.add_dependency "solidus_backend", ">= 1.3.0.a", "< 2.4"
